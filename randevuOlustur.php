...
<body>
    ...
    <div class="kapsayici">
		...
		<a href="anasayfa.php"><img src="YBS-Logo-png-e1598794278240.png" class="randevuOlusturLogo"></a>
        ...
        <div class="sagDiv">
		<form  action="randevuVtKaydet.php" method="post">
...
</form><a href="anasayfa.php"><button class="buttonn"type="submit" >Anasayfa</button></a>
            </div>
        </div></div>	
